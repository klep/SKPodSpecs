# coding: utf-8
#
#  Be sure to run `pod spec lint SKBatcher.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    SKBatcher intelligently loads, preloads, and caches content for cases where
  ...
  s.homepage     = "https://github.com/klep/SKBatcher"
...
#s.license      = "MIT"
  ...
  s.author             = { "Scott J. Kleper" => "spods@klep.me" }
  # Or just: s.author    = "Scott J. Kleper"
  # s.authors            = { "Scott J. Kleper" => "klep@venturehacks.com" }
  s.social_media_url   = "http://twitter.com/klep"
  ...
  s.source       = { :git => "https://github.com/klep/SKBatcher.git", :tag => "#{s.version}" }
